...
Relevant code snippets for the digital optical neural network project in Dirk Englund's group
...
Relevant code on how to generate a model with the same hyperparameters as what we used in our experiment are found in generate_network_and_dataset.py
